  ...
  <div>
    ...
    >
      ...
      <div v-if="showCropper" class="flex flex-col gap-6 py-2">
        ...
        <div
          class="bg-gray-100 dark:bg-gray-950 rounded-[0.75rem]] overflow-hidden min-h-[380px] border border-gray-200 dark:border-gray-800"
        >
          <Cropper
            ref="cropperRef"
            :src="rawImage"
      ...
      <form
        ...
        class="space-y-6 animate-in fade-in slide-in-from-bottom-3 duration-300 py-2"
      >
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 items-start">
              ...
              <div class="space-y-2">
                <div class="flex items-center justify-between min-h-[20px]">
                  <label
                    class="text-xs font-black text-gray-600 dark:text-gray-400 uppercase tracking-widest ml-1"
                  >
                    Amostra Visual
                  </label>
                  <div
                    class="flex bg-gray-100 dark:bg-gray-800/80 p-1 rounded-xl w-[120px]"
                  >
                    <button
                      type="button"
                      @click="
                ...
                >
                  ...
                  >
                    <label
                      class="p-2 min-h-[36px] min-w-[36px] flex items-center justify-center bg-white dark:bg-gray-800 rounded-xl text-gray-900 dark:text-white cursor-pointer hover:scale-105 transition-transform shadow-md"
                    >
                ...
                <div
                  v-if="!isPhotoType && !form.imageUrl"
                  class="w-full animate-in fade-in zoom-in-95 duration-200"
                >
                ...
                <div
                  v-if="isPhotoType && form.imageUrl == ''"
                  class="transition-all animate-fadeIn"
                >
                  <label
                  ...
                  >
                    ...
                    >
                      <!-- Ícone de upload -->
                      <svg
                        class="w-8 h-8 mb-2 text-gray-400 group-hover:text-blue-500 transition-colors"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
          ...
          <div class="space-y-6">
            ...
            <div class="space-y-2">
              <div class="flex justify-between items-center px-1">
                <label
                  class="block text-xs font-black text-gray-600 dark:text-gray-400 uppercase tracking-widest"
                >
                  Descrição Comercial
                </label>
                <BaseButton
                  ...
                  :disabled="
                    isSuggesting ||
                    !form.name.trim() ||
                    form.name.length > maxCatalogSuggestName
                  "
