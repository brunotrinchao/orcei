...
<template>
  <div class="space-y-6 max-w-xl mx-auto py-2 wizard-product-container">
    <!-- Dica Inicial -->
    <div class="flex items-center gap-3 p-4 bg-blue-50/60 dark:bg-blue-950/20 rounded-xl border border-blue-100 dark:border-blue-900/40">
    ...
    <div class="space-y-4">
      ...
      <div class="space-y-2">
        <label class="block text-xs font-black text-slate-700 dark:text-gray-400 uppercase tracking-widest ml-1">
          Tipo de Item
        </label>
      ...
      <div class="space-y-2">
        ...
        <textarea
          ...
          class="w-full px-4 py-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl text-xs text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-600 focus:border-transparent outline-none transition-all"
        ></textarea>
      </div>
    </div>
  </div>
