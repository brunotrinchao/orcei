...
<template>
  <div @click="$emit('open-info')" class="rounded-[0.75rem] border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm p-4 cursor-pointer hover:border-gray-300 dark:hover:border-gray-700 transition-all proposal-card-container">
    <!-- topo: ref + badge -->
