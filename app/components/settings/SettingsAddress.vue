...
<template>
  <section id="endereco" class="bg-white p-8 rounded-[2.5rem] border border-gray-200 shadow-sm scroll-mt-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div class="space-y-3">
        <label for="address-zip" class="block text-xs font-black text-gray-600 uppercase tracking-widest ml-1">CEP *</label>
        <div class="relative">
          <input
            id="address-zip"
      ...
      <div class="md:col-span-2 space-y-3">
        <label for="address-street" class="block text-xs font-black text-gray-600 uppercase tracking-widest ml-1">Rua / Logradouro *</label>
        <input
          id="address-street"
