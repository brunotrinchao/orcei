  ...
  <section id="visual" data-tour="config-visual" class="bg-white dark:bg-gray-900 p-8 rounded-[2.5rem] border border-gray-200 dark:border-gray-800 shadow-sm scroll-mt-8">
    <div class="flex items-center gap-3 mb-8">
      <div class="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-950/50 flex items-center justify-center">
        <SwatchBook class="w-5 h-5 text-blue-600 dark:text-blue-400" />
      </div>
      ...
      <div class="space-y-3">
        ...
        <div class="flex gap-3">
          <div class="relative flex-1">
            ...
            >
            <div class="absolute left-4 top-1/2 -translate-y-1/2 w-7 h-7 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm" :style="{ backgroundColor: localPrimaryColor }"></div>
          </div>
          <input
            v-model="localPrimaryColor"
            type="color"
            class="w-14 h-15 p-1 bg-white dark:bg-gray-800 border-2 border-gray-100 dark:border-gray-700 rounded-2xl cursor-pointer focus-visible:ring-2 focus-visible:ring-blue-600 outline-none"
