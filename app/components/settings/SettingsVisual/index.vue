...
<template>
  <BaseSectionCard id="visual" data-tour="config-visual" title="Identidade Visual" :icon="SwatchBook" icon-bg-class="bg-blue-50 dark:bg-blue-950/50" icon-color-class="text-blue-600 dark:text-blue-400">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-10 settings-visual-container">
      <div class="md:col-span-2 flex flex-col md:flex-row items-center gap-10 p-6 bg-gray-50/50 dark:bg-gray-800/50 rounded-[0.75rem] border border-gray-200 dark:border-gray-700">
        <div class="relative group">
          <div class="w-32 h-32 bg-white dark:bg-gray-900 rounded-[0.75rem] border-4 border-white dark:border-gray-800 shadow-xl flex items-center justify-center overflow-hidden transition-all group-hover:scale-105 duration-300 ring-1 ring-gray-100 dark:ring-gray-800">
      ...
      <!-- Dark Mode -->
      <div class="md:col-span-2 flex items-center justify-between p-6 bg-gray-50/50 dark:bg-gray-800/50 rounded-[0.75rem] border border-gray-200 dark:border-gray-700">
        <div class="flex items-center gap-3">
          <div class="w-8 h-8 rounded-[0.75rem] bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-500 dark:text-gray-400">
            <ClientOnly>
