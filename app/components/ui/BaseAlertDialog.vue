...
<template>
  <AlertDialogRoot :open="open" @update:open="emit('update:open', $event)">
    <AlertDialogPortal>
      ...
      >
        <AlertDialogContent 
          class="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] max-w-md bg-white dark:bg-gray-900 rounded-[0.5rem] p-8 shadow-2xl z-[301] focus:outline-none border border-gray-100 dark:border-gray-800"
        >
