...
const variants = {
  default: 'bg-slate-100 dark:bg-gray-800 text-slate-700 dark:text-gray-300 border border-slate-200 dark:border-gray-700',
  ...
  ia: 'bg-violet-200 dark:bg-violet-900/30 text-violet-800 dark:text-violet-400 border border-violet-700/50 dark:border-violet-800/50',
