...
<template>
  <div>
    ...
    <span class="block min-h-[14px] text-[10px] font-bold text-red-500 ml-1 uppercase leading-[14px]">{{ showRequiredError ? 'Campo obrigatório' : '' }}</span>
  </div>
</template>
