...
<template>
  <div class="space-y-2">
    ...
    <div class="flex items-center gap-3">
      <div class="relative w-14 h-14 rounded-[0.75rem] overflow-hidden border-2 border-gray-100 dark:border-gray-800 shadow-sm shrink-0">
        <input
          :id="inputId"
          type="color"
          v-model="colorValue"
      ...
      <div class="relative flex-1">
        ...
        <input
          ...
          maxlength="6"
          :disabled="disabled"
          class="w-full pl-8 pr-5 py-4 bg-white dark:bg-gray-950 border-2 border-gray-100 dark:border-gray-800 hover:border-gray-200 dark:hover:border-gray-700 rounded-[0.75rem] focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 dark:focus:border-blue-500 transition-all outline-none font-mono font-bold text-gray-900 dark:text-gray-50 uppercase placeholder:text-gray-400 dark:placeholder:text-gray-500"
        >
      </div>
    </div>
  </div>
