...
<template>
  <div class="w-full">
    <!-- TABLE TYPE -->
    <div v-if="type === 'table'" class="bg-white dark:bg-gray-900 rounded-[0.75rem] border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden transition-all">
