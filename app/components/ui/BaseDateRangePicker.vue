      ...
      <div class="relative">
        ...
        <PopoverPortal>
          <PopoverContent
            ...
            :side-offset="8"
            align="end"
            class="z-[99999] bg-white dark:bg-gray-900 rounded-[.5rem] border border-gray-300 dark:border-gray-800 shadow-2xl p-6 animate-in fade-in zoom-in-95 duration-200 min-w-[320px]"
          >
            <div class="space-y-8">
              <!-- Presets -->
