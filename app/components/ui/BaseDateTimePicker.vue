...
<template>
  <div class="space-y-2">
    ...
    <PopoverRoot v-model:open="isOpen">
      <div class="relative">
        <PopoverTrigger
          class="w-full flex items-center gap-3 px-5 py-4 bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 rounded-[0.5rem] transition-all text-left focus:ring-4 focus:ring-blue-500/20 focus:border-blue-600 outline-none group"
        >
        ...
        <PopoverContent
            ...
            :side-offset="8"
            align="start"
            class="z-[100] bg-white dark:bg-gray-900 rounded-[0.5rem] border-2 border-gray-100 dark:border-gray-700 shadow-2xl dark:shadow-gray-950/50 p-6 sm:p-6 animate-in fade-in zoom-in-95 duration-200 min-w-[320px] max-w-[90vw]"
          >
            <div class="space-y-6">
              ...
              <div class="space-y-3">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  <button 
                    ...
                    class="px-3 py-2 rounded-[0.5rem] text-[9px] font-black uppercase tracking-widest bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400 hover:bg-blue-50 dark:hover:bg-blue-950/40 hover:text-blue-600 dark:hover:text-blue-400 transition-all border border-transparent hover:border-blue-100 dark:hover:border-blue-900/50"
                  >
                    {{ p.label }}
                  </button>
                </div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div class="space-y-2">
                  ...
                  <input 
                    ...
                    type="date"
                    class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800 border-2 border-gray-100 dark:border-gray-700 hover:border-gray-200 dark:hover:border-gray-600 rounded-[0.5rem] focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none font-bold text-sm text-gray-900 dark:text-white transition-all cursor-pointer"
                  >
                </div>
              ...
              <div class="pt-4 border-t border-gray-50 dark:border-gray-800 flex gap-3">
                <button 
                  @click="clear"
                  class="flex-1 px-4 py-3 rounded-[0.5rem] text-[10px] font-black uppercase tracking-widest text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-white transition-all"
                >
                  Limpar
                </button>
                <button 
                  @click="apply"
                  class="flex-[2] px-4 py-3 rounded-[0.5rem] text-[10px] font-black uppercase tracking-widest bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 hover:bg-black dark:hover:bg-white transition-all shadow-lg dark:shadow-gray-950/50"
                >
                  Confirmar Data
                </button>
              </div>
