  ...
  <div class="w-full">
    ...
    <div class="md:hidden">
      ...
      <button 
        ...
        class="w-full h-[58px] px-6 bg-white dark:bg-gray-900 border-2 border-gray-100 dark:border-gray-800 rounded-2xl flex items-center justify-between text-gray-500 dark:text-gray-400 hover:border-blue-200 dark:hover:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/50 active:scale-98 transition-all relative shadow-sm"
      >
