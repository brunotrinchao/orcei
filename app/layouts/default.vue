      ...
      <nav class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <div class="flex items-center gap-12">
          ...
          <div v-if="loggedIn" class="hidden md:flex gap-1.5 items-center">
            <NuxtLink to="/dashboard" @mouseenter="preloadRouteComponents('/dashboard')" @focus="preloadRouteComponents('/dashboard')" class="px-3.5 py-2 rounded-[0.75rem] text-xs font-bold text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-slate-200/60 dark:hover:bg-gray-800/50 transition-all" active-class="!text-blue-600 dark:!text-blue-400 font-black bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900/40 shadow-sm">Dashboard</NuxtLink>
            <NuxtLink to="/clientes" @mouseenter="preloadRouteComponents('/clientes')" @focus="preloadRouteComponents('/clientes')" class="px-3.5 py-2 rounded-[0.75rem] text-xs font-bold text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-slate-200/60 dark:hover:bg-gray-800/50 transition-all" active-class="!text-blue-600 dark:!text-blue-400 font-black bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900/40 shadow-sm">Clientes</NuxtLink>
            <NuxtLink to="/catalogo" @mouseenter="preloadRouteComponents('/catalogo')" @focus="preloadRouteComponents('/catalogo')" class="px-3.5 py-2 rounded-[0.75rem] text-xs font-bold text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-slate-200/60 dark:hover:bg-gray-800/50 transition-all" active-class="!text-blue-600 dark:!text-blue-400 font-black bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900/40 shadow-sm">Catálogo</NuxtLink>
            <NuxtLink to="/orcamentos" @mouseenter="preloadRouteComponents('/orcamentos')" @focus="preloadRouteComponents('/orcamentos')" class="px-3.5 py-2 rounded-[0.75rem] text-xs font-bold text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-slate-200/60 dark:hover:bg-gray-800/50 transition-all" active-class="!text-blue-600 dark:!text-blue-400 font-black bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900/40 shadow-sm">Orçamentos</NuxtLink>
            <NuxtLink to="/agenda" @mouseenter="preloadRouteComponents('/agenda')" @focus="preloadRouteComponents('/agenda')" class="px-3.5 py-2 rounded-[0.75rem] text-xs font-bold text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-slate-200/60 dark:hover:bg-gray-800/50 transition-all" active-class="!text-blue-600 dark:!text-blue-400 font-black bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900/40 shadow-sm">Agenda</NuxtLink>
            <NuxtLink to="/relatorios" @mouseenter="preloadRouteComponents('/relatorios')" @focus="preloadRouteComponents('/relatorios')" class="px-3.5 py-2 rounded-[0.75rem] text-xs font-bold text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-slate-200/60 dark:hover:bg-gray-800/50 transition-all" active-class="!text-blue-600 dark:!text-blue-400 font-black bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900/40 shadow-sm">Relatórios</NuxtLink>
          </div>
