      ...
      <nav class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <div class="flex items-center gap-12">
          ...
          <div v-if="loggedIn" class="hidden md:flex gap-1.5 items-center">
            <NuxtLink to="/dashboard" @mouseenter="preloadRouteComponents('/dashboard')" @focus="preloadRouteComponents('/dashboard')" class="px-3.5 py-2 rounded-[0.75rem] text-xs font-bold text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100/50 dark:hover:bg-gray-800/50 transition-all" active-class="!text-blue-600 dark:!text-blue-400 font-black bg-blue-50 dark:bg-blue-950/40 border border-blue-100 dark:border-blue-900/40 shadow-sm">Dashboard</NuxtLink>
            <NuxtLink to="/clientes" @mouseenter="preloadRouteComponents('/clientes')" @focus="preloadRouteComponents('/clientes')" class="px-3.5 py-2 rounded-[0.75rem] text-xs font-bold text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100/50 dark:hover:bg-gray-800/50 transition-all" active-class="!text-blue-600 dark:!text-blue-400 font-black bg-blue-50 dark:bg-blue-950/40 border border-blue-100 dark:border-blue-900/40 shadow-sm">Clientes</NuxtLink>
            <NuxtLink to="/catalogo" @mouseenter="preloadRouteComponents('/catalogo')" @focus="preloadRouteComponents('/catalogo')" class="px-3.5 py-2 rounded-[0.75rem] text-xs font-bold text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100/50 dark:hover:bg-gray-800/50 transition-all" active-class="!text-blue-600 dark:!text-blue-400 font-black bg-blue-50 dark:bg-blue-950/40 border border-blue-100 dark:border-blue-900/40 shadow-sm">Catálogo</NuxtLink>
            <NuxtLink to="/orcamentos" @mouseenter="preloadRouteComponents('/orcamentos')" @focus="preloadRouteComponents('/orcamentos')" class="px-3.5 py-2 rounded-[0.75rem] text-xs font-bold text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100/50 dark:hover:bg-gray-800/50 transition-all" active-class="!text-blue-600 dark:!text-blue-400 font-black bg-blue-50 dark:bg-blue-950/40 border border-blue-100 dark:border-blue-900/40 shadow-sm">Orçamentos</NuxtLink>
            <NuxtLink to="/agenda" @mouseenter="preloadRouteComponents('/agenda')" @focus="preloadRouteComponents('/agenda')" class="px-3.5 py-2 rounded-[0.75rem] text-xs font-bold text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100/50 dark:hover:bg-gray-800/50 transition-all" active-class="!text-blue-600 dark:!text-blue-400 font-black bg-blue-50 dark:bg-blue-950/40 border border-blue-100 dark:border-blue-900/40 shadow-sm">Agenda</NuxtLink>
            <NuxtLink to="/relatorios" @mouseenter="preloadRouteComponents('/relatorios')" @focus="preloadRouteComponents('/relatorios')" class="px-3.5 py-2 rounded-[0.75rem] text-xs font-bold text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100/50 dark:hover:bg-gray-800/50 transition-all" active-class="!text-blue-600 dark:!text-blue-400 font-black bg-blue-50 dark:bg-blue-950/40 border border-blue-100 dark:border-blue-900/40 shadow-sm">Relatórios</NuxtLink>
          </div>
        ...
        <div class="flex items-center gap-2 md:gap-3">
          <template v-if="loggedIn">
            ...
            <div class="hidden md:flex items-center gap-2 md:gap-3.5 bg-slate-50 dark:bg-slate-900/60 px-2.5 md:px-3.5 py-1.5 rounded-[0.75rem] border border-slate-100 dark:border-slate-800/80 shadow-inner mr-0.5 md:mr-1">
              <!-- Créditos -->
            ...
            <button
              ...
              class="relative w-10 h-10 rounded-[0.75rem] items-center justify-center bg-gray-50 dark:bg-gray-900/60 hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400 border border-slate-100 dark:border-slate-800/80 shadow-sm hover:ring-4 ring-gray-100 dark:ring-gray-800/50 transition-all flex cursor-pointer"
            ...
            <div ref="menuRef" class="hidden md:block relative">
              <button 
                @click="toggleMenu" 
                class="w-10 h-10 rounded-[0.75rem] bg-gray-50 dark:bg-gray-900 flex items-center justify-center overflow-hidden hover:ring-4 ring-gray-100 dark:ring-gray-800/50 transition-all border border-slate-100 dark:border-slate-800/80 shadow-sm relative z-[60]"
              >
              ...
              <!-- Dropdown Desktop -->
              <div v-if="isMenuOpen" class="absolute right-0 mt-3 w-48 bg-white dark:bg-gray-900 rounded-[0.75rem] shadow-xl border border-gray-100 dark:border-gray-700 py-1.5 overflow-hidden ring-1 ring-black/5 dark:ring-white/5 z-[70]">
