    ...
    <div v-if="localProfile">
      ...
      <div class="lg:hidden flex gap-2 overflow-x-auto pb-3 mb-6 scrollbar-hide">
        <button
          ...
          class="shrink-0 flex items-center gap-1.5 px-4 py-2.5 rounded-[0.5rem] text-[10px] font-black uppercase tracking-widest transition-all"
        >
      ...
      <div class="flex gap-8 items-start">
        ...
        <aside class="hidden lg:flex flex-col gap-1 w-44 shrink-0 sticky top-24">
          <button
            ...
            class="flex items-center gap-2.5 px-4 py-3 rounded-[0.5rem] text-xs font-black uppercase tracking-widest transition-all text-left"
          >
            ...
            <div :key="activeSection">
              ...
              >
                <div class="space-y-6">
                  ...
                  <div class="p-5 bg-emerald-50/60 dark:bg-emerald-950/30 rounded-[0.5rem] border border-emerald-200/60 dark:border-emerald-900/40 flex items-start gap-4">
                    <div class="w-10 h-10 bg-emerald-100 dark:bg-emerald-900/50 rounded-[0.5rem] flex items-center justify-center shrink-0 text-emerald-600 dark:text-emerald-400 mt-0.5">
                  ...
                  <div class="p-6 bg-gray-50/50 dark:bg-gray-950/50 rounded-[0.5rem] border border-gray-100 dark:border-gray-800 space-y-4">
                    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                      <div class="flex items-center gap-4">
                        <div class="w-12 h-12 bg-white dark:bg-gray-900 rounded-[0.5rem] shadow-sm flex items-center justify-center shrink-0 border border-gray-100 dark:border-gray-800">
                    ...
                    <div class="pt-3 border-t border-gray-100 dark:border-gray-900 grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                      <div class="p-3 bg-white dark:bg-gray-900 rounded-[0.5rem] border border-gray-100 dark:border-gray-800/80">
              ...
              >
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div class="p-8 bg-gray-50/50 dark:bg-gray-950/50 rounded-[0.5rem] border border-gray-100 dark:border-gray-800 space-y-4">
                  ...
                  <div class="p-8 bg-orange-50/30 dark:bg-orange-950/20 rounded-[0.5rem] border border-orange-100 dark:border-orange-900/30 space-y-4">
                  ...
                  <div class="p-8 bg-red-50/30 dark:bg-red-950/20 rounded-[0.5rem] border border-red-100 dark:border-red-900/30 space-y-4">
