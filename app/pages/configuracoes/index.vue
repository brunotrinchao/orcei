            ...
            <div :key="activeSection">
              ...
              >
                <div class="space-y-6">
                  ...
                  <div class="p-5 bg-emerald-50/60 dark:bg-emerald-950/30 rounded-3xl border border-emerald-200/60 dark:border-emerald-900/40 flex items-start gap-4">
                    <div class="w-10 h-10 bg-emerald-100 dark:bg-emerald-900/50 rounded-2xl flex items-center justify-center shrink-0 text-emerald-600 dark:text-emerald-400 mt-0.5">
                  ...
                  <div class="p-6 bg-gray-50/50 dark:bg-gray-950/50 rounded-3xl border border-gray-100 dark:border-gray-800 space-y-4">
                    ...
                    <div class="pt-3 border-t border-gray-100 dark:border-gray-900 grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                      <div class="p-3 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800/80">
