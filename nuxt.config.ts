...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    // Cadeia de fallback de IA (DeepSeek → Gemini → Cloudflare → OpenRouter,
    // ver server/services/AIService.ts): cada provedor liga/desliga por env
    ...
    aiMaxProposalWizardPrompt: Number(process.env.AI_MAX_PROPOSAL_WIZARD_PROMPT) || 1000,
    aiMaxClientExtractRawText: Number(process.env.AI_MAX_CLIENT_EXTRACT_RAW_TEXT) || 1500,
    aiMaxCatalogSuggestContext: Number(process.env.AI_MAX_CATALOG_SUGGEST_CONTEXT) || 500,
    aiMaxCatalogSuggestName: Number(process.env.AI_MAX_CATALOG_SUGGEST_NAME) || 150,
    aiMaxGenerateItemDescription: Number(process.env.AI_MAX_GENERATE_ITEM_DESCRIPTION) || 300,
    public: {
      aiMaxProposalWizardPrompt: Number(process.env.AI_MAX_PROPOSAL_WIZARD_PROMPT) || 1000,
      aiMaxClientExtractRawText: Number(process.env.AI_MAX_CLIENT_EXTRACT_RAW_TEXT) || 1500,
      aiMaxCatalogSuggestContext: Number(process.env.AI_MAX_CATALOG_SUGGEST_CONTEXT) || 500,
      aiMaxCatalogSuggestName: Number(process.env.AI_MAX_CATALOG_SUGGEST_NAME) || 150,
      siteUrl: process.env.NUXT_PUBLIC_SITE_URL || 'https://orceifacil.com.br',
      appUrl: process.env.NUXT_PUBLIC_APP_URL || 'https://app.orceifacil.com.br',
      publicProposalUrl: process.env.PUBLIC_PROPOSAL_URL || 'https://orcamento.orceifacil.com.br',
