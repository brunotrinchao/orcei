...
export default defineEventHandler(async () => {
  ...
  return {
    ...
    landingPage: {
      appName,
      heroTitle:
        settings?.landingPage?.heroTitle ||
        `Crie orçamentos profissionais em segundos com IA`,
      heroSubtitle:
        settings?.landingPage?.heroSubtitle ||
        `A plataforma definitiva para freelancers e pequenas agências gerenciarem vendas e fecharem mais negócios.`,
