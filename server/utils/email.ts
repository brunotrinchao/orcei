  ...
  try {
    const response = await $fetch('https://api.resend.com/emails', {
      ...
      body: {
        ...
        to: clientEmail,
        subject: `Orçamento: ${professionalName} preparou uma proposta para você`,
        html: `
          <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 40px; border: 1px solid #eee; border-radius: 20px;">
            ...
            <p style="font-size: 16px; color: #666; line-height: 1.6;">${professionalName} acaba de enviar uma proposta comercial exclusiva para você.</p>
            ...
            <a href="${proposalUrl}" style="display: inline-block; background: #000; color: #fff; padding: 16px 32px; border-radius: 12px; text-decoration: none; font-weight: bold; font-size: 14px; text-transform: uppercase; letter-spacing: 1px;">Visualizar Proposta</a>
